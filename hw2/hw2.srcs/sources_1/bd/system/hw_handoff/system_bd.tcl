...
proc create_root_design { parentCell } {
  ...
  set btn_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 btn_0 ]
  set btn_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 btn_1 ]
  ...
  set btn_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 btn_0 ]
  set_property -dict [ list \
  ...
  set btn_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 btn_1 ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
   CONFIG.C_GPIO_WIDTH {1} \
   CONFIG.C_INTERRUPT_PRESENT {1} \
  ...
  # Create instance: revolve_ctrl, and set properties
  set revolve_ctrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_gpio:2.0 revolve_ctrl ]
  set_property -dict [ list \
   CONFIG.C_ALL_INPUTS {1} \
  ...
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports switches] [get_bd_intf_pins revolve_ctrl/GPIO]
  connect_bd_intf_net -intf_net btn_0_GPIO [get_bd_intf_ports btn_0] [get_bd_intf_pins btn_0/GPIO]
  connect_bd_intf_net -intf_net btn_1_GPIO [get_bd_intf_ports btn_1] [get_bd_intf_pins btn_1/GPIO]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins ps7_0_axi_periph/M00_AXI] [get_bd_intf_pins revolve_ctrl/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins btn_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins btn_1/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  ...
  connect_bd_intf_net -intf_net revolve_ctrl_GPIO2 [get_bd_intf_ports btns] [get_bd_intf_pins revolve_ctrl/GPIO2]

  # Create port connections
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net btn_0_ip2intc_irpt [get_bd_pins btn_0/ip2intc_irpt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net btn_1_ip2intc_irpt [get_bd_pins btn_1/ip2intc_irpt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins btn_0/s_axi_aclk] [get_bd_pins btn_1/s_axi_aclk] [get_bd_pins led/s_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins revolve_ctrl/s_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins btn_0/s_axi_aresetn] [get_bd_pins btn_1/s_axi_aresetn] [get_bd_pins led/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins revolve_ctrl/s_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs btn_0/S_AXI/Reg] SEG_btn_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41210000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs btn_1/S_AXI/Reg] SEG_btn_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41230000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led/S_AXI/Reg] SEG_led_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x41220000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs revolve_ctrl/S_AXI/Reg] SEG_revolve_ctrl_Reg
